...
**Note:** In order for the simulation function to work properly, the `MASS` package must be installed!
...
sigma_beta_scale <- c(0.1, 0.1, 0.1, 5, 0.001)
