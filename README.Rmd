...
Senf, C., Pflugmacher D., Heurich, M. and Krueger T. (*under review*) A Bayesian hierarchical model for estimating spatial and temporal variation in vegetation phenology from Landsat time series. *Remote Sensing of Environment*.

**How to cite the code**

If you use the code you might want to cite it using the following DOI:
