...
mu_beta <- matrix(c(0.1, # Season minimum 
                    0.3, # Season amplitude
                    0.2, # Green-up rate
                    120, # Start of season
