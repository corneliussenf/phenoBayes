...
In order to run the models you need to first install `rstan`. Information on how to installing `rstan` on your machine can be found here: https://github.com/stan-dev/rstan/wiki/RStan-Getting-Started.
...
sigma_beta_scale <- c(0, 0.05, 0.05, 10, 0.00001)
